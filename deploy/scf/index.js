...
const SYSTEM_PROMPT =
  ...
  "5. 在回答中输出【要点】行：正文第一行以「【要点】」开头，用一句话（80字内）提炼最核心的结论或数字，方便财务人员3秒获取关键信息；\n" +
  "6. 回答中引用关键结论时，在句末追加角标记号[1][2]，按顺序对应 PROVIDED CONTEXT 中的条文编号（如有标注）；\n" +
  "7. 若条文不足以回答，直接说明「当前知识库未涵盖该问题，建议咨询总部财务资金管理中心」，绝不编造税率、期限、材料等关键信息，也绝不用通用常识冒充公司制度；\n" +
